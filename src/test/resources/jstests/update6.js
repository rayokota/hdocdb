...
assert.eq( 4 , t.find({_id:2},{b3:1})[0].b3.keySet().size(), "test 1 : ks before" );
t.update({_id:2},{$inc: { 'b3.0719' : 1}});
assert.eq( 5 , t.find({_id:2},{b3:1})[0].b3.keySet().size(), "test 1 : ks after" );
...
assert.eq( 4 , t.find({_id:2},{b3:1})[0].b3.keySet().size() , "test 2 : ks before" );
printjson( t.find({_id:2},{b3:1})[0].b3 );
t.update({_id:2},{$inc: { 'b3.0719' : 1}} );
printjson( t.find({_id:2},{b3:1})[0].b3 );
assert.eq( 5 , t.find({_id:2},{b3:1})[0].b3.keySet().size() , "test 2 : ks after" );
